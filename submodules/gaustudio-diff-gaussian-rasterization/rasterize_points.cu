	...
	const bool debug)
{
  ...
  return std::make_tuple(rendered, out_color, out_depth, out_median_depth, out_opacity, radii, geomBuffer, binningBuffer, imgBuffer, gs_w);
}
...
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor>
 RasterizeGaussiansBackwardCUDA(
	...
	const torch::Tensor& dL_dout_final_opacity,
	const torch::Tensor& sh,
	const int degree,
	const torch::Tensor& campos,
	...
	const bool debug) 
{
  ...
  {  
	  ...
	  dL_dout_final_opacity.contiguous().data<float>(),
