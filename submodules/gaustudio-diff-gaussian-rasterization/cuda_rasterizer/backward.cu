...
renderCUDA(
	...
	const float* __restrict__ dL_dpixel_final_opacitys,
...
void BACKWARD::render(
	...
	const float* dL_dpixel_final_opacitys,
	float4* dL_dmean2D,
	float4* dL_dconic2D,
	float* dL_dopacity,
	float* dL_dcolors,
